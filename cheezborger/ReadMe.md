...
|Content Editor| • Add markdown to page<br> • Add image asset to page<br> • Add video asset to page<br> • Remove elements from a page<br> • Create new subpage<br> • Set metadata for site|
...
|Asset Filer| • Writes external and genrated image/video content to storage|
